...
OSSA v0.1.8 specialist tier agent for testing operations with UADP discovery protocol support.

## Features

- 🚀 OSSA v0.1.8 compliant
- 🔍 UADP discovery protocol
- 🎯 specialist conformance tier
...
ossa discovery find --capabilities testing_analysis
...
- **CrewAI**: testing specialist role
