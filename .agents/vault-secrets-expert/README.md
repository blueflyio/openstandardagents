...
OSSA v0.1.8 advanced tier agent for governance operations with UADP discovery protocol support.
...
ossa discovery find --capabilities governance_analysis
...
- **CrewAI**: governance specialist role
