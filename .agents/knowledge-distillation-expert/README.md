# knowledge-distillation-expert Agent
...
OSSA v0.1.8 advanced tier agent for cognitive operations with UADP discovery protocol support.
...
ossa discovery find --capabilities cognitive_analysis
...
- **CrewAI**: cognitive specialist role
