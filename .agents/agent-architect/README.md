...
OSSA v0.1.8 advanced tier agent for integration operations with UADP discovery protocol support.
...
ossa discovery find --capabilities integration_analysis
...
- **CrewAI**: integration specialist role
