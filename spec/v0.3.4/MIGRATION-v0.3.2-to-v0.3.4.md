# Migration Guide: OSSA v0.3.2 → v0.3.4
...
OSSA v0.3.4 introduces **Skills Compatibility Extension** for interoperability with Anthropic Skills and AgentSkills.io specifications.

### Key Changes

- ✅ **Backward Compatible**: v0.3.2 manifests validate against v0.3.4 schema
