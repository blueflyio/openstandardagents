# OSSA v0.3.4 Runtime Specification
...
|---------|------|---------|
| 0.3.4 | 2024-01 | Initial runtime specification with lifecycle, control signals, execution model, network isolation, and memory model |
