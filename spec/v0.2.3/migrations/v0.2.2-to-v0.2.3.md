# Migration Guide: OSSA v0.2.2 → v0.2.3

**Migration Difficulty**: 🟢 **Trivial** (No breaking changes)
...
- 📚 Enhanced documentation (README, wikis, examples)
- 📖 6 new migration guides (LangChain, CrewAI, OpenAI, etc.)
- 🏷️ Improved inline example annotations
...
```bash
# Update globally
npm update -g @bluefly/open-standards-scalable-agents
...
```diff
- Documentation: https://gitlab.bluefly.io/llm/openapi-ai-agents-standard/-/tree/v0.2.2
+ Documentation: https://gitlab.bluefly.io/llm/openapi-ai-agents-standard/-/tree/v0.2.3
...
|--------|------------------|------------------|-------|
| `apiVersion: ossa/v0.2.2` | ✅ Valid | ✅ Valid | Backward compatible |
| `apiVersion: ossa/v0.2.3` | ✅ Valid | ✅ Valid | Forward compatible |
| `apiVersion: ossa/v1` | ✅ Valid | ✅ Valid | Alias for v0.2.x |
...
npm install -g @bluefly/open-standards-scalable-agents@0.2.2
```
...
$agent = new OssaAgent('my-agent', 'v0.2.2');  // ✅
$agent = new OssaAgent('my-agent', 'v0.2.3');  // ✅
```
...
agent = OSSAAgent.from_manifest('agent-v0.2.2.yaml')  # ✅
agent = OSSAAgent.from_manifest('agent-v0.2.3.yaml')  # ✅
```
...
### 3. GitLab Wiki
- **URL**: https://gitlab.bluefly.io/llm/openapi-ai-agents-standard/-/wikis/home
