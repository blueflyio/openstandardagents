...
OSSA (Open Standard for Scalable AI Agents) v0.2.6 is a minor release introducing enhanced transport metadata, state management, security features, and capability versioning for better framework integration.

## What's in This Directory

- **`ossa-0.2.6.schema.json`** - JSON Schema definition for OSSA v0.2.6 agent manifests
- **`ossa-0.2.6.yaml`** - YAML specification document
...
- **Supported API Versions**: `ossa/v0.2.2`, `ossa/v0.2.3`, `ossa/v0.2.4`, `ossa/v0.2.6`, `ossa/v1`

## Migration

To upgrade from previous versions, see the migration guides:
- [v0.2.4 → v0.2.6](./migrations/v0.2.4-to-v0.2.6.md)
- [v0.2.3 → v0.2.6](./migrations/v0.2.3-to-v0.2.6.md)
...
- **Schema URL**: https://openstandardagents.org/schemas/v0.2.6/agent.json
