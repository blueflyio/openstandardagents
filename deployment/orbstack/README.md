...
kubectl apply -f deployment/orbstack/namespace.yaml
kubectl apply -f deployment/orbstack/postgresql.yaml
kubectl apply -f deployment/orbstack/mongodb.yaml
kubectl apply -f deployment/orbstack/minio.yaml
kubectl apply -f deployment/orbstack/agent-router.yaml
kubectl apply -f deployment/orbstack/agent-tracer.yaml
kubectl apply -f deployment/orbstack/agent-chat.yaml
kubectl apply -f deployment/orbstack/openstandardagents.yaml
...
Edit `deployment/orbstack/agent-router.yaml` and update:
...
```bash
# Delete applications
kubectl delete -f deployment/orbstack/openstandardagents.yaml
kubectl delete -f deployment/orbstack/agent-chat.yaml
kubectl delete -f deployment/orbstack/agent-tracer.yaml
kubectl delete -f deployment/orbstack/agent-router.yaml
helm uninstall qdrant -n development

# Delete databases
kubectl delete -f deployment/orbstack/minio.yaml
kubectl delete -f deployment/orbstack/mongodb.yaml
kubectl delete -f deployment/orbstack/postgresql.yaml
