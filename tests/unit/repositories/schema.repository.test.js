...
describe('SchemaRepository', () => {
    ...
    describe('getSchema()', () => {
        it('should load v1.0 schema', async () => {
            ...
            expect(schema.properties.ossaVersion).toBeDefined();
        ...
        it('should throw error for unsupported version', async () => {
            await expect(repository.getSchema('999.0')).rejects.toThrow('Unsupported schema version');
        });
...
//# sourceMappingURL=schema.repository.test.js.map