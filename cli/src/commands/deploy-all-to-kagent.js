...
const { convertOSSAtoKagent } = require('./convert-to-kagent');
...
async function deployAllAgents(options = {}) {
  ...
  const agentTypes = ['workers', 'orchestrators', 'monitors', 'critics', 'judges', 'governors', 'integrators'];
...
if (require.main === module) {
  ...
  const options = {
    ...
    namespace: args.includes('--namespace') ? args[args.indexOf('--namespace') + 1] : 'default'
  };
...
module.exports = { deployAllAgents };
