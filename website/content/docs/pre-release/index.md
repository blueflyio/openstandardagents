...
- `spec/v0.3.0/examples/customer-support-graph.ossa.yaml` - Sequential process
- `spec/v0.3.0/examples/research-team.ossa.yaml` - Hierarchical process
- `spec/v0.3.0/examples/parallel-processors.ossa.yaml` - Parallel process
