...
Customer support agent with access to order management and knowledge base

**File**: [`migrations/langchain/04-config-based-before.yaml`](https://github.com/blueflyio/openstandardagents/blob/main/examples/migrations/langchain/04-config-based-before.yaml)

```bash
ossa validate examples/migrations/langchain/04-config-based-before.yaml
```
