# OSSA {{OSSA_VERSION_TAG}} Release Notes
...
Version {{OSSA_VERSION}} focuses on critical bug fixes, documentation improvements, and website enhancements to improve the developer experience and project stability.
...
- Updated all version references to 0.2.8
...
```bash
npm install @bluefly/openstandardagents@{{OSSA_VERSION}}
```
