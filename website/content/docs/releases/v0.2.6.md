...
Version 0.3.0 focuses on critical bug fixes, documentation improvements, and website enhancements to improve the developer experience and project stability.
...
```bash
npm install @bluefly/openstandardagents@0.3.0
```
