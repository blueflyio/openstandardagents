...
**Location**: [OSSA/spec/v0.2.5-RC/ossa-0.2.5.schema.json](https://gitlab.bluefly.io/llm/OSSA/-/blob/development/spec/v0.2.5-RC/ossa-0.2.5.schema.json)
...
- **OSSA Specification Schema**: [OSSA 1.0 Schema](https://gitlab.bluefly.io/llm/OSSA/-/blob/development/spec/v0.2.5-RC/ossa-0.2.5.schema.json)
