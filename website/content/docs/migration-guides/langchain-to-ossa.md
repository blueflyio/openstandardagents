...
5. **Join the community**
   ...
   - [Examples Repository](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/tree/main/examples)
   - [Issue Tracker](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/issues)
...
### Examples
- [Simple Worker Agent](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/tree/main/agents/review-agents)
- [Orchestrator Agent](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/tree/main/agents/executive-agents)
- [Multi-Agent System](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/tree/main/examples)

### Tools
- [Agent Validator](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/blob/main/src/cli/agents/validate.ts)
- [Migration Script](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/blob/main/scripts/migrate-agents-to-ossa.ts)
- [Agent Templates](https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/tree/main/templates/agents)

### Support
- **Issues**: https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/issues
- **Discussions**: https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/merge_requests
- **Wiki**: https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/wikis/home
...
*For questions or issues with this migration guide, please create an issue at: https://gitlab.com/blueflyio/agent-platform/agent-buildkit/-/issues*
