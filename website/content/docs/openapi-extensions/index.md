...
- **OSSA Specification**: [spec/v0.2.8/OSSA-SPECIFICATION-v0.2.x.md](https://github.com/blueflyio/openstandardagents/blob/main/spec/v0.2.8/OSSA-SPECIFICATION-v0.2.2.md)
