...
- **OSSA Specification**: [spec/{{OSSA_VERSION_TAG}}/OSSA-SPECIFICATION-v0.2.x.md](https://github.com/blueflyio/openstandardagents/blob/main/spec/{{OSSA_VERSION_TAG}}/OSSA-SPECIFICATION-{{OSSA_VERSION_TAG}}.md)
