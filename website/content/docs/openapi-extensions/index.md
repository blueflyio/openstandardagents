...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-metadata)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-agent)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-capability)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-autonomy)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-constraints)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-tools)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-llm)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-agent-id)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-version)
...
**See**: [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#x-ossa-capability-schema)
...
See: [`examples/openapi-extensions/minimal-agent-api.openapi.yml`](https://gitlab.com/blueflyio/openstandardagents/blob/main/examples/openapi-extensions/minimal-agent-api.openapi.yml)

### Worker Agent API

See: [`examples/openapi-extensions/worker-agent-api.openapi.yml`](https://gitlab.com/blueflyio/openstandardagents/blob/main/examples/openapi-extensions/worker-agent-api.openapi.yml)

### Orchestrator Agent API

See: [`examples/openapi-extensions/orchestrator-agent-api.openapi.yml`](https://gitlab.com/blueflyio/openstandardagents/blob/main/examples/openapi-extensions/orchestrator-agent-api.openapi.yml)
...
See [Full Documentation](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md#integration-with-ossa-manifests) for details.
...
- **Full Documentation**: [docs/openapi-extensions.md](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md)
- **JSON Schema**: [docs/schemas/openapi-extensions.schema.json](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/schemas/openapi-extensions.schema.json)
- **Examples**: [examples/openapi-extensions/](https://gitlab.com/blueflyio/openstandardagents/tree/main/examples/openapi-extensions)
- **OSSA Specification**: [spec/{{OSSA_VERSION_TAG}}/OSSA-SPECIFICATION-v0.2.x.md](https://gitlab.com/blueflyio/openstandardagents/blob/main/spec/{{OSSA_VERSION_TAG}}/OSSA-SPECIFICATION-{{OSSA_VERSION_TAG}}.md)
- **npm Package**: [@bluefly/openstandardagents](https://www.npmjs.com/package/@bluefly/openstandardagents)

---

*For complete documentation with all examples and details, see the [main documentation file](https://gitlab.com/blueflyio/openstandardagents/blob/main/docs/openapi-extensions.md).*
