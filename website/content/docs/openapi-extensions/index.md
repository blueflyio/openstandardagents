...
- **OSSA Specification**: [spec/v0.3.0/OSSA-SPECIFICATION-v0.2.x.md](https://gitlab.com/blueflyio/openstandardagents/-/blob/main/spec/v0.3.0/OSSA-SPECIFICATION-v0.3.0.md)
