...
description: "OSSA v0.3.2 WebSocket transport protocol for bidirectional real-time agent communication"
weight: 2
---

# WebSocket Transport Protocol

Bidirectional, real-time communication between OSSA agents over persistent connections.
...
metadata:
  ...
  version: 1.0.0
spec:
  role: Real-time data processor
  capabilities:
    - name: process_data
      description: Process incoming data streams
    - name: analyze_content
      description: Analyze content in real-time
  transport:
    websocket:
      enabled: true
      endpoint: wss://agent.example.com/ws
      subprotocol: ossa.v0.3.2
      keepalive:
        interval: 30
        timeout: 5
      reconnect:
...
- Supported subprotocols: `ossa.v0.3.2`
...
**Next**: [Server-Sent Events (SSE)](./sse) - Learn about server-to-client streaming
