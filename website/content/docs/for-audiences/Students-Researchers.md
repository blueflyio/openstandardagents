...
- OSSA Specification: [spec/v0.2.2/ossa-0.2.2.schema.json](https://github.com/BlueflyCollective/openstandardagents/blob/main/spec/v0.2.2/ossa-0.2.2.schema.json)
- Examples Library: [examples/](https://github.com/BlueflyCollective/openstandardagents/-/tree/main/examples)
...
- [Hello World Complete](https://github.com/BlueflyCollective/openstandardagents/blob/main/examples/getting-started/hello-world-complete.ossa.yaml)
...
- [Repository](https://github.com/BlueflyCollective/openstandardagents)
