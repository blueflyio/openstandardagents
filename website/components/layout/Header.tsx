    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      <nav className="container mx-auto max-w-6xl px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2 text-sm lg:text-base">
        ...
        >
          <div
            id="mobile-menu"
            className="py-4 border-t border-gray-200 space-y-1"
            role="navigation"
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-3 py-2 text-gray-600 hover:text-primary-600 hover:bg-gray-50 rounded-lg font-medium transition-all duration-200"
              onClick={() => setMobileMenuOpen(false)}
              title="View on GitHub"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
