    ...
    <div className="bg-gradient-to-r from-primary to-secondary text-white rounded-lg p-8 shadow-xl">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          <Link href="/docs/getting-started/5-minute-overview" className="text-white hover:underline flex items-center gap-2">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Quick Start Guide
          </Link>
          <Link href="/examples" className="text-white hover:underline flex items-center gap-2">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
            </svg>
            View Examples
          </Link>
          <Link href="/docs" className="text-white hover:underline flex items-center gap-2">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
