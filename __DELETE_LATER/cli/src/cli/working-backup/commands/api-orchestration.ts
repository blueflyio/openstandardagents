...
export function registerGraphQLCommands(program: Command): void {
...
function displayWorkflowsTable(workflows: Workflow[]): void {
...
function displayExecutionDetails(execution: WorkflowExecution): void {
...
function displayGraphQLResponse(response: any): void {
...
function displaySchemaTypes(types: any[]): void {
...
async function watchExecution(executionId: string, json: boolean = false): Promise<void> {
...
function getExecutionStatusColor(status: string): 'green' | 'yellow' | 'red' | 'blue' | 'gray' {
  switch (status) {
...
function getWorkflowTemplate(templateName: string): WorkflowDefinition {
...
function displayWorkflowTemplates(): void {
...
async function promptWorkflowDefinition(): Promise<WorkflowDefinition> {
