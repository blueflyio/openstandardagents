...
export class OSSAAgentService {
     ...
     */
    async handoffToAgent(fromAgentId, toAgentId, context) {
     ...
     */
    async orchestrateSequential(agentIds, initialMessage) {
        const results = [];
     ...
     */
    async orchestrateParallel(agentIds, message) {
     ...
     */
    async createCodeAgent(name, instructions) {
        const codeTools = [
            {
                type: 'function',
                function: {
     ...
     */
    async createResearchAgent(name, instructions) {
        const searchTools = [
            {
                type: 'function',
                function: {
