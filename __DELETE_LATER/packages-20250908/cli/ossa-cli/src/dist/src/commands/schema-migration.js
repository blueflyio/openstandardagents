...
class SchemaTransformationEngine {
     ...
     */
    async transformAgentToAPI(agentPath, outputPath) {
     ...
     */
    addCapabilityPaths(paths, capabilities) {
     ...
     */
    addOperationPaths(paths, operations) {
     ...
     */
    async writeSpec(spec, outputPath) {
     ...
     */
    async generateDocumentation(spec, specPath) {
     ...
     * Generate ReDoc HTML documentation
     */
    generateReDocHTML(spec, specPath) {
 ...
 */
async function batchTransformAgents(pattern, outputDir, options) {
    ...
    try {
        ...
        for (const file of files) {
            ...
            const outputFile = path.join(outputDir, `${baseName}-api.${options.outputFormat || 'yaml'}`);
 ...
 */
export function createSchemaMigrationCommands() {
...
export { SchemaTransformationEngine };
