...
OSSA v0.1.8 specialist tier agent for research operations with UADP discovery protocol support.
...
ossa discovery find --capabilities research_analysis
...
- **CrewAI**: research specialist role
