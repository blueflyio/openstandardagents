...
OSSA v0.1.8 specialist tier agent for documentation operations with UADP discovery protocol support.
...
ossa discovery find --capabilities documentation_analysis
...
- **CrewAI**: documentation specialist role
