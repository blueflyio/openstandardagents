...
OSSA v0.1.8 specialist tier agent for requirements operations with UADP discovery protocol support.
...
ossa discovery find --capabilities requirements_analysis
...
- **CrewAI**: requirements specialist role
