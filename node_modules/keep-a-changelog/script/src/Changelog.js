...
class Changelog {
    ...
    findRelease(version) {
        ...
        const parsed = typeof version === "string" ? (0, deps_js_1.parse)(version) : version;
        return this.releases.find((release) => release.parsedVersion && (0, deps_js_1.equals)(release.parsedVersion, parsed));
    }
    sortReleases() {
    ...
    compareLink(previous, release) {
        ...
        if (this.tagLinkBuilder) {
            ...
            return this.tagLinkBuilder(url, this.tagName(release), this.tagName(previous), this.head);
        }
        if (!previous) {
