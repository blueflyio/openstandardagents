# human-collaboration-coordinator Agent
...
OSSA v0.1.8 advanced tier agent for collaboration operations with UADP discovery protocol support.
...
ossa discovery find --capabilities collaboration_analysis
...
- **CrewAI**: collaboration specialist role
