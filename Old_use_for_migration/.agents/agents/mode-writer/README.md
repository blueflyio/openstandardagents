...
OSSA v0.1.8 specialist tier agent for configuration operations with UADP discovery protocol support.
...
ossa discovery find --capabilities configuration_analysis
...
- **CrewAI**: configuration specialist role
