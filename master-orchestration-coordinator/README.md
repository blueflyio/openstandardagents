# master-orchestration-coordinator Agent
...
OSSA v0.1.8 advanced tier agent for specialized operations with UADP discovery protocol support.
...
ossa discovery find --capabilities specialized_analysis
...
- **CrewAI**: specialized specialist role
