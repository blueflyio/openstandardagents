...
This directory contains OSSA-compliant agent definitions for use in GitLab CI/CD pipelines.

## Purpose

These agents demonstrate how to use OSSA schema to define CI/CD automation agents that can be used in GitLab CI pipelines. Each agent is a complete, valid OSSA manifest showcasing v0.2.4 features.
