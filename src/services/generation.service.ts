...
export class GenerationService {
  ...
  async exportToPlatform(
    ...
    switch (platform) {
      ...
      case 'crewai': {
        return CrewAIAdapter.toCrewAI(manifest) as unknown as Record<
          string,
          unknown
        >;
      }
      ...
      case 'langchain': {
        return LangChainAdapter.toLangChain(manifest) as unknown as Record<
          string,
          unknown
        >;
      }
      ...
      case 'langflow': {
        return LangflowAdapter.toLangflow(manifest) as unknown as Record<
          string,
          unknown
        >;
      }
      ...
      case 'openapi': {
        return OpenAPIAdapter.toOpenAPI(manifest) as unknown as Record<
          string,
          unknown
        >;
      }
