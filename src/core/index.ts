...
export const SPECIFICATION_VERSION =
  '@bluefly/open-standards-scalable-agents@0.1.9';
...
export const PROJECT_URLS = {
  ...
  changelog:
    'https://gitlab.bluefly.io/llm/openapi-ai-agents-standard/-/releases',
} as const;
...
export const IMPLEMENTATION_REFS = {
  ...
  registryBridge:
    'https://gitlab.bluefly.io/llm/agent_buildkit/-/tree/main/src/registry',
