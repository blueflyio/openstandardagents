...
function showSuccessMessage(agentFile: string, provider: string): void {
  ...
  console.log(`     ${chalk.gray('Docs:     ')}${chalk.cyan('https://openstandardagents.org/docs')}`);
  console.log(`     ${chalk.gray('Spec:     ')}${chalk.cyan('https://openstandardagents.org/spec')}`);
  console.log(`     ${chalk.gray('GitHub:   ')}${chalk.cyan('https://github.com/blueflyio/openstandardagents')}`);
