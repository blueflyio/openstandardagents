 ...
 * Generated on: 2026-01-06T18:10:13.454Z
 */
...
export const registrationRequestSchema = z.object({
  agentId: z.string().max(253).regex(/^[a-z0-9]([-a-z0-9]*[a-z0-9])?$/),
  name: z.string().max(253).regex(/^[a-z0-9]([-a-z0-9]*[a-z0-9])?$/),
...
export const discoveryQuerySchema = z.object({
  domain: z.string().regex(/^domain::[a-z0-9-]+$/).optional(),
  subdomain: z.string().regex(/^subdomain::[a-z0-9-]+$/).optional(),
  concerns: z.array(z.string().regex(/^concern::[a-z0-9-]+$/)).optional(),
  capabilities: z.array(z.string().regex(/^[a-z][a-z0-9_-]*$/)).optional(),
