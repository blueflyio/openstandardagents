...
/**
 * Open Standard for Scalable AI Agents (OSSA) v0.3.4 - Unified Task Schema with Access Tiers & Separation of Duties. Supports Agent (agentic loops with LLM), Task (deterministic workflow steps), and Workflow (composition of Tasks and Agents) kinds. Includes Agent-to-Agent Messaging Extension and Access Control Tiers for privilege separation.
 */
export type OSSAV032ManifestSchema = {
  [k: string]: unknown;
} & {
  /**
   * OSSA API version (v0.3.4+ supports Task and Workflow kinds)
   */
  apiVersion: string;
  /**
