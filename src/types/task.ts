 ...
 */
export function isOssaTask(manifest: unknown): manifest is OssaTask {
  return (
    typeof manifest === 'object' &&
    manifest !== null &&
    'kind' in manifest &&
    (manifest as Record<string, unknown>).kind === 'Task'
  );
}
 ...
 */
export function createTaskManifest(name: string, options?: Partial<OssaTask>): OssaTask {
  return {
