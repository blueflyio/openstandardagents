 ...
 */
export declare function isOssaWorkflow(manifest: unknown): manifest is OssaWorkflow;
/**
 * Create an empty Workflow manifest with defaults
 */
export declare function createWorkflowManifest(name: string, options?: Partial<OssaWorkflow>): OssaWorkflow;
/**
 * Helper to create a workflow step
 */
export declare function createStep(id: string, kind: WorkflowStepKind, options?: Partial<WorkflowStep>): WorkflowStep;
/**
 * Helper to create an expression reference
 * @example expr('steps.fetch.output.content') => '${{ steps.fetch.output.content }}'
 */
export declare function expr(path: string): string;
