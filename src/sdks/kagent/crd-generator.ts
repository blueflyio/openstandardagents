...
export class KAgentCRDGenerator {
  ...
  private generateReadme(
    ...
    readme += '- [kubectl Cheat Sheet](https://kubernetes.io/docs/reference/kubectl/cheatsheet/)\n\n';
   ...
   */
  private extractGovernance(governance: unknown): Record<string, unknown> | undefined {
   ...
   * Extract workflow configuration
   */
  private extractWorkflow(workflow: unknown): Record<string, unknown> | undefined {
   ...
   * Extract monitoring configuration
   */
  private extractMonitoring(monitoring: unknown): Record<string, unknown> | undefined {
