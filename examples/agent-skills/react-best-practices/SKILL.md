...
This skill is available as an OSSA v0.3.5 agent:

- **OSSA Manifest**: `examples/ossa-templates/11-react-performance-expert.ossa.yaml`
- **Auto-activation**: Keywords, file patterns, frameworks
- **Tools**: Bundle analyzer, waterfall detector, re-render analyzer
- **MoE Experts**: Deep analysis, standard analysis, quick scan
- **BAT Framework**: Technology selection based on complexity
...
- Ask about React performance
- Work with `.tsx` or `.jsx` files
- Mention "optimize", "slow", "bundle", "waterfall"
- Use Next.js or React frameworks
...
# Use via agent
ossa run react-performance-expert --analyze src/components/
```
...
grep -r "barrel" examples/agent-skills/react-best-practices/references/
grep -r "waterfall" examples/agent-skills/react-best-practices/references/
```
...
- **React.cache**: Eliminates duplicate requests per render

---

**Source**: Based on [Vercel agent-skills](https://github.com/vercel-labs/agent-skills/tree/main/skills/react-best-practices)  
**OSSA Version**: v0.3.5  
