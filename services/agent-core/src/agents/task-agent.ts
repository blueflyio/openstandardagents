...
export class TaskAgent extends BaseAgent implements ITaskAgent {
  ...
  public capabilities: ITaskAgent['capabilities'];
   ...
   * Schedule a task
   */
  public async scheduleTask(task: TaskDefinition, schedule: Schedule): Promise<string> {
   ...
   */
  protected async executeTaskLogic(task: TaskDefinition): Promise<any> {
