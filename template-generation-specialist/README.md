# template-generation-specialist Agent
...
OSSA v0.1.8 advanced tier agent for template operations with UADP discovery protocol support.
...
ossa discovery find --capabilities template_analysis
...
- **CrewAI**: template specialist role
