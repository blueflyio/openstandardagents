# GitLab CI/CD Components Usage - OSSA Platform

This document explains how the OSSA project uses the GitLab CI/CD Components Library v0.1.0 with automatic version detection.

## 🔗 Components Included

### 1. Git-Flow Workflow (`workflow/git-flow@0.1.0`)
- **Purpose**: Complete branching strategy with OpenAPI validation
- **Features**: Automated tagging, merge management, automatic version detection from package.json
- **Configuration**:
  ```yaml
  inputs:
    component_version: "0.1.0"
    # project_version automatically detected from package.json (v0.1.9)
    project_type: "ossa"
