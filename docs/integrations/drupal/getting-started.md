...
## Drupal and Discovery (DUADP)

Agents running within Drupal can also be registered with the **[DUADP](http://duadp.org/)** network. This allows your Drupal-based agents to be discovered and used by other agents in your OSSA ecosystem.

```bash
# Register your Drupal agent
ossa lifecycle duadp-register my-drupal-agent.ossa.yaml
```
