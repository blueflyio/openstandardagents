...
# Expected output:
# 📝 Migration Preview (my-agent.ossa.yaml)
# ─────────────────────────────────────────────────────────────────
...
# Expected output:
# ✓ Migrated my-agent.ossa.yaml
# ✓ Backup created: my-agent.ossa.yaml.bak
# ✓ Validation passed
...
```
✅ SUCCESS: my-agent.ossa.yaml is valid
──────────────────────────────────────────────────────────────
✓ Schema: v0.3.0 (valid)
✓ Kind: Agent (valid)
